...
const addTwo = (arr) => {
  let localarrayy=[]
 for(let i=0;i<localarrayy.length;i++)
 {

localarrayy.push(arr[i]+2)
...
const containsAnd = (arr) => {
 let arrays1=arr.filter((index) =>index.includes('and'))
 return arrays1;
};
...
const oddValues = (arr) => {
  ...
  let localarray2=arr.filter(index11=>{
    if(index11%2!==0){
      return index11;
    }
  })
